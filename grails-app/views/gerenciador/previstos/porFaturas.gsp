...
<div class="container">
    ...
    <g:render template="cabecalhoPrevisao" model="[valorReceita: 4000, valorDespesa:(((faturas*.valor.sum{it}) ?: 0) + ((itensFaturasConvertidos*.valor.sum{it}) ?: 0)), valorTerceiro: (faturas*.valorTerceiro.sum{it})]" />
